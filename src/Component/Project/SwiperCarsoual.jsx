      ...
      <div className="absolute mt-10 lg:flex hidden top-[-60px] right-[10px] z-10 gap-2">
        ...
        >
          <svg
            ...
            className="font-semibold text-White cursor-pointer transition duration-300 hover:scale-125"
          >
            <path
          ...
          <SwiperSlide key={index}>
            <div className="relative">
              <img
                ...
                className="object-cover w-full h-full rounded-2xl transition duration-300 border hover:border-White border-Black"
              />
              <div className="absolute right-0 py-3 text-2xl font-medium text-White lg:bottom-10 font-title bottom-5 left-5 lg:left-10 text-start">
                {slide.text}
              </div>
            </div>
          </SwiperSlide>
