        ...
        <div className="grid grid-cols-1 gap-6 py-12 sm:grid-cols-2 lg:grid-cols-4">
          {cards.map((card) => (
            ...
            >
              ...
              />
              <div className="p-6">
                <h3 className="text-2xl font-medium text-White font-sora">{card.title}</h3>
                <p className="text-lg font-medium text-zinc-300 font-sora">{card.description}</p>
              </div>
            </div>
          ))}
        </div>
...
export default ServicesPageComponent3;