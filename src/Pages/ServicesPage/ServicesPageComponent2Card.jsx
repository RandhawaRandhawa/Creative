...
const ServicesPageComponent2Card = () => {
  return (
    <div className="container relative z-10 pt-10 mx-auto pb-28">
      <div className="flex items-center justify-center">
        <div className="grid w-5/6 h-full grid-cols-1 gap-10 lg:grid-cols-1">
          {services.map((service, index) => (
            ...
            >
              ...
              <a href="#">
                <h3 className="mt-6 text-3xl font-medium font-sora text-Primary">
                  {service.title}
                </h3>
              </a>

              <p className="mt-4 text-md font-sora text-zinc-300">
...
export default ServicesPageComponent2Card;
