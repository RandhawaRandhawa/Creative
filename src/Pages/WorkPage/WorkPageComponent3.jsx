...
const WorkPageComponent3 = () => {
  ...
  return (
    <div className="relative min-h-full px-2 py-10 mx-auto max-w-screen-xl bg-White/5 backdrop-blur-sm">
      ...
      <h1 className="mb-8 text-4xl font-medium lg:text-5xl text-White font-sora">
        ...
        <p className="mt-8 text-zinc-300 font-sora lg:text-lg text-md">
        We are the perfect professional team of designers and developers for you. Creative is a top website and mobile app development company. In addition, empowering our clients sincerely by developing complete customized mobile and the web-based digital solution is our mission.
        </p>
      </div>
      ...
      <dl className="grid grid-cols-1 gap-4 mt-8 divide-y mg-6 divide-AccentCoral lg:mt-32 sm:grid-cols-2 sm:divide-x sm:divide-y-0 lg:grid-cols-3">
        {counts.map((stat, index) => (
          <div key={index} className="flex flex-col px-4 py-2 text-center">
            <dt className="order-last mt-2 font-medium text-md lg:text-lg font-sora text-zinc-300">
              {stat.label}
            </dt>
            <dd className="text-4xl font-bold font-sora text-White lg:text-5xl">
...
export default WorkPageComponent3;